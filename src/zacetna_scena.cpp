...
void Zacetna_scena::posodobi_meni()
{
    ...
    if (m_b_igraj.ali_je_miska_gor())
    {
        ...
        {
            Risalnik::narisi_besedilo(m_pisava, 0xffffffff, mat::vec2(0), 0.05, "POVEZOVANJE", R_P_X_SREDINA);
            Risalnik::konec_okvir(); // Da se zgornja zadeva narise
            konec();
